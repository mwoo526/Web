...
module.exports = {
	...
	db_schemas: [
	    {file:'./user_schema', collection:'users35', schemaName:'UserSchema', modelName:'UserModel'}
        ,{file:'./device_schema',collection:'devices21', schemaName:'DeviceSchema',modelName:'DeviceModel'}
        ,{file:'./store_schema',collection:'store34', schemaName:'StoreSchema',modelName:'StoreModel'}
        ,{file:'./review_schema',collection:'review16', schemaName:'ReviewSchema',modelName:'ReviewModel'}
